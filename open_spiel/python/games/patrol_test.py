...
from open_spiel.python.games import patrol  # pylint: disable=unused-import
from open_spiel.python.observation import make_observation
import pyspiel


class PatrolTest(absltest.TestCase):
  ...
  #   py_game = pyspiel.load_game("python_patrol")
  #   cc_game = pyspiel.load_game("patrol")
